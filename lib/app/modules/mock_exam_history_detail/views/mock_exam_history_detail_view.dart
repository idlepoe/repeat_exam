...
class MockExamHistoryDetailView
  ...
  Widget build(BuildContext context) {
    return Obx(() {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OutlinedButton(onPressed: () => Get.offAllNamed('/exam-type-list'), child: const Text('목록으로')),
                ],
              ),
            ),
          ),
      ...
      final correctExplanation = (ai?['correctExplanation'] as String?)?.trim() ?? '';
      final wrongAnswerNotesRaw = ai?['wrongAnswerNotes'];
      final wrongAnswerNotes = wrongAnswerNotesRaw is List
          ? wrongAnswerNotesRaw.map((e) => e.toString()).where((e) => e.trim().isNotEmpty).toList()
          : <String>[];
              ...
              children: [
                Container(
                  ...
                  child: SafeArea(
                    ...
                    child: Row(
                      children: [
                        OutlinedButton(onPressed: () => Get.back(), child: const Text('뒤로가기')),
                        Expanded(
                          child: Text(
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      RichText(
                        text: TextSpan(
                          style: const TextStyle(color: Color(0xFF111111), fontSize: 16, height: 1.5),
                          children: [
                            TextSpan(text: '${controller.index.value + 1}. ', style: const TextStyle(fontWeight: FontWeight.w600)),
                      ...
                      if (hasAiExplanation) ...[
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              const Text('AI 해설', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
                              if (correctExplanation.isNotEmpty) ...[
                                const SizedBox(height: 8),
                                const Text('정답 해설', style: TextStyle(fontWeight: FontWeight.w600)),
                                const SizedBox(height: 4),
                                Text(correctExplanation),
                              ],
                              if (wrongAnswerNotes.isNotEmpty) ...[
                                const SizedBox(height: 10),
                                const Text('오답 노트', style: TextStyle(fontWeight: FontWeight.w600)),
                                const SizedBox(height: 4),
                                ...wrongAnswerNotes.map((note) => Padding(
                              ...
                              if (examTip.isNotEmpty) ...[
                                const SizedBox(height: 10),
                                const Text('쪽집게', style: TextStyle(fontWeight: FontWeight.w600)),
                                const SizedBox(height: 4),
                                Text(examTip),
                              ],
                            ],
                  ...
                  child: Center(
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text('안내', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 17)),
                          const SizedBox(height: 12),
                          const Text('목록으로 이동하시겠습니까?'),
                          const SizedBox(height: 16),
                          FilledButton(onPressed: controller.confirmMoveList, child: const Text('확인')),
                          const SizedBox(height: 8),
                          OutlinedButton(onPressed: controller.cancelMoveList, child: const Text('취소')),
                        ],
                      ),
                    ),
                  ),
            ...
            child: Column(
              ...
              children: [
                const Align(
                  ...
                  child: Text('답안 확인', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 17)),
                ),
                const SizedBox(height: 12),
                Flexible(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      final status = ans == null ? '미응답' : isCorrect ? '정답' : '오답';
                      ...
                      return TextButton(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 4),
                            Text('선택: ${ans == null ? '—' : '$ans번'} / 정답: ${qq.correct_answer}번'),
